...
int FFUImage::AddEntryToRawProgram(TCHAR* szRawProgram, TCHAR* szFileName, uint64_t ui64FileOffset, int64_t i64StartSector, uint64_t ui64NumSectors) {
    HANDLE hRawPrg;
...
int FFUImage::SplitFFUBin(TCHAR* szPartName, TCHAR* szOutputFile) {
    ...
    swprintf_s(szNewFile, _T("%ls\\%ls.bin"), szOutputFile, GptEntries[i].part_name);
